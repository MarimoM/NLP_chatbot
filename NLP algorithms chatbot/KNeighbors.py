...
testavimoLaikasSuma = 0.0
for e in testavimo_laikas:
    testavimoLaikasSuma += e.microseconds

print("Testavimo laikas: ", testavimoLaikasSuma)
